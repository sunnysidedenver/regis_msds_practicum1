...
Two approaches were explored in order to predict crime. The first involves a using a multivariate regression. The second a time series analysis and forecast.
